...
export const products: Product[] = [
  {
    ...
    fullDescription: `Thang máy quan sát Hải Phát được thiết kế với cabin kính toàn cảnh, lắp đặt bên ngoài các công trình cao tầng như khách sạn, trung tâm thương mại, tòa nhà văn phòng và biệt thự cao cấp. Với tầm nhìn 360 độ, thang máy quan sát không chỉ là phương tiện di chuyển mà còn là điểm nhấn kiến trúc độc đáo, nâng tầm giá trị thẩm mỹ cho công trình.
...
Cabin kính được chế tạo từ kính cường lực an toàn đa lớp, chịu được chênh lệch áp suất và điều kiện thời tiết khắc nghiệt. Hệ thống dẫn hướng và đối trọng được bố trí khéo léo để không cản trở tầm nhìn, kết hợp với hệ thống chiếu sáng LED tạo hiệu ứng ánh sáng ấn tượng về đêm.`,
    ...
    specifications: [
      ...
      { label: 'Kiểu lắp', value: 'Ngoài công trình / Trong giếng trời' },
  ...
  },
  {
    ...
    fullDescription: `Thang Máy Gia Đình Hải Phát được thiết kế riêng biệt cho từng không gian sống, mang đến sự tiện nghi và đẳng cấp cho gia đình bạn. Với công nghệ tiên tiến từ các thương hiệu hàng đầu thế giới như Mitsubishi, Otis, Fuji, chúng tôi cam kết mang đến sản phẩm chất lượng cao với vận hành êm ái, an toàn tuyệt đối.

Dòng thang máy gia đình của chúng tôi phù hợp với nhiều kiểu kiến trúc khác nhau - từ nhà phố liền kề, biệt thự cổ điển đến biệt thự hiện đại. Cabin có thể tùy chỉnh với nhiều vật liệu cao cấp: kính cường lực trong suốt, inox mờ, gỗ tự nhiên hay laminate chống trầy xước.`,
    features: [
    ...
    faqs: [
      { question: 'Nhà tôi diện tích nhỏ, có lắp được thang máy không?', answer: 'Có thể. Chúng tôi có các dòng thang máy gia đình mini với kích thước cabin chỉ từ 1.0m x 1.2m, phù hợp với nhà phố nhỏ.' },
      ...
      { question: 'Thang máy gia đình tốn nhiều điện không?', answer: 'Không. Thang tiêu thụ khoảng 2-5 kWh/ngày, tương đương chi phí 5,000-12,000 VND/ngày.' },
...
Chúng tôi cung cấp các dòng thang từ tốc độ tiêu chuẩn 1.0 m/s đến tốc độ cao 2.5 m/s cho các tòa nhà cao tầng. Thiết kế cabin hiện đại với nhiều lựa chọn nội thất cao cấp, đáp ứng mọi yêu cầu thẩm mỹ khắt khe nhất.`,
    ...
    relatedProjects: ['landmark-office', 'sheraton-da-nang'],
  },
];
